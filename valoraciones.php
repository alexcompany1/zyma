    ...
    <main class="main-content">
        ...
        <?php if (empty($productos)): ?>
            <div class="empty-state">
                <p data-i18n="reviews.noProducts">No hay productos disponibles en este momento.</p>
            </div>
        <?php else: ?>
                        ...
                        <div class="product-rating-info">
                            ...
                            <?php if ($is_logged_in): ?>
                                <form class="quick-rating-form" data-product-id="<?= $pid ?>" data-product-name="<?= htmlspecialchars($producto['nombre']) ?>">
                                    ...
                                    <!-- Botón enviar -->
                                    <button type="submit" class="btn-rate-product" <?= $mi_valoracion ? 'data-i18n="reviews.update"' : 'data-i18n="reviews.rate"' ?>>
