...
<header class="landing-header unified-header">
  <div class="landing-bar">
    ...
    <div class="landing-actions">
      <?php if (!$is_logged_in): ?>
        <a href="login.php" class="landing-link" data-i18n="auth.loginBtn">Entrar</a>
        <a href="registro.php" class="landing-cta" data-i18n="landing.createAccount">Crear cuenta</a>
      <?php endif; ?>
