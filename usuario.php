...
<main class="container user-home">
  <section class="user-home-hero">
    ...
    <aside class="user-home-spotlight">
      ...
      <ul class="user-home-shortcuts">
        ...
        <li><a href="incidencias.php" data-i18n="user.openIncidents">Abrir o revisar incidencias</a></li>
        <li><a href="tickets.php" data-i18n="user.myPurchaseTickets">Ver mis tickets de compra</a></li>
  ...
  <section class="user-home-links">
    <?php if ($starProduct): ?>
      <a class="user-link-card user-link-card-star" href="carta.php?producto=<?= urlencode((string) $starProduct['id']) ?>">
        ...
        <p data-i18n="user.starCardDesc">Accede directamente al hotdog estrella del momento en una vista dedicada solo para ese producto.</p>
      </a>
    <?php endif; ?>
    ...
    <a class="user-link-card" href="tickets.php">
      <span class="user-link-tag" data-i18n="user.purchasesCardKicker">Compras</span>
      <h3 data-i18n="user.purchasesCardTitle">Revisa tus comprobantes</h3>
      <p data-i18n="user.purchasesCardDesc">Accede a tus tickets de compra y facturas cuando lo necesites.</p>
    </a>
  </section>
  ...
  <?php if (!empty($featuredProducts)): ?>
    <section class="user-home-section">
      <div class="user-home-section-head">
        <div>
          <span class="user-home-card-kicker" data-i18n="user.favoritesKicker">Favoritos del cliente</span>
          <h2 data-i18n="user.favoritesTitle">Los productos que más compran nuestros clientes</h2>
        </div>
        <a href="carta.php" class="user-home-inline-link" data-i18n="user.viewAll">Ver toda la carta</a>
      </div>
  ...
  <?php if (!empty($resenias)): ?>
    <section class="user-home-section user-home-reviews">
      <div class="user-home-section-head">
        <div>
          <span class="user-home-card-kicker" data-i18n="user.reviewsSection">Reseñas</span>
